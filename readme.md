# [![Java CI with Maven](https://github.com/kwasiad/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/kwasiad/spring-petclinic/actions/workflows/maven.yml)
